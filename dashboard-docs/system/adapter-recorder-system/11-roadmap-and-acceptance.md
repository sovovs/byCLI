...
11. **M10 · MVP acceptance** — ✅ verified 2026-06-25
    - all acceptance items below pass (each row mapped to passing tests/evidence; real-daemon E2E runs in CI on every PR; coverage ≥80% is not yet gated — follow-up).
