...
**M0–M7 landed; M8 is next.** Implementation status (detail + per-milestone log in `../../architecture-relationship.md` and the impl memory):
...
11. **M10 · MVP acceptance**
    - all acceptance items below pass.
