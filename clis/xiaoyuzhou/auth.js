...
import { CliError, CommandExecutionError, ConfigError, EXIT_CODES, getErrorMessage } from '@sovovs/bycli/errors';
...
export function getXiaoyuzhouCredentialFile() {
    return path.join(os.homedir(), '.bycli', 'xiaoyuzhou.json');
}
