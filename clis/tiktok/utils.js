...
//
// - Node-side: input validation (typed errors per byCLI rules).
...
export function normalizeUsername(value) {
    ...
    if (!username) {
        throw new ArgumentError(
            ...
            'Example: bycli tiktok following <username>',
        );
    }
...
export function requireCommentText(value) {
    ...
    if (!text) {
        throw new ArgumentError(
            ...
            'Example: bycli tiktok comment <url> "great video"',
        );
    }
...
export function parseTikTokVideoUrl(value) {
    ...
    if (!raw) {
        throw new ArgumentError(
            ...
            'Example: bycli tiktok comment https://www.tiktok.com/@user/video/1234567890 "..."',
        );
    }
    let parsed;
    try {
