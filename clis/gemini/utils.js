...
const GEMINI_COMPOSER_MARKER_ATTR = 'data-bycli-gemini-composer';
...
function exportGeminiDeepResearchReportScript(maxWaitMs) {
    ...
    (async () => {
      ...
      const recorderKey = '__bycliGeminiExportUrls';
      const patchedKey = '__bycliGeminiExportPatched';
      const trace = [];
      ...
      const ensureRecorder = () => {
        ...
        XMLHttpRequest.prototype.open = function(method, url, ...rest) {
          ...
          try { this.__bycliReqUrl = String(url || ''); } catch {}
          ...
          try {
            this.addEventListener('load', () => {
              try {
                ...
                const reqUrl = String(this.__bycliReqUrl || '');
                if (isDriveDocCreateRequest(reqUrl)) {
