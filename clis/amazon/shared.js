...
const AMAZON_RANKING_SPECS = {
    bestsellers: {
        ...
        invalidInputHint: 'Example: bycli amazon bestsellers https://www.amazon.com/Best-Sellers/zgbs',
    },
    new_releases: {
        ...
        invalidInputHint: 'Example: bycli amazon new-releases https://www.amazon.com/gp/new-releases',
    },
    movers_shakers: {
        ...
        invalidInputHint: 'Example: bycli amazon movers-shakers https://www.amazon.com/gp/movers-and-shakers',
    },
};
...
export function buildProductUrl(input) {
    ...
    if (!asin) {
        throw new ArgumentError('amazon product expects an ASIN or product URL', 'Example: bycli amazon product B0FJS72893');
    }
...
export function buildDiscussionUrl(input) {
    const asin = extractAsin(input);
    if (!asin) {
        throw new ArgumentError('amazon discussion expects an ASIN or product URL', 'Example: bycli amazon discussion B0FJS72893');
    }
...
export function buildChallengeHint(action) {
    return [
        ...
        'If you are using CDP, set BYCLI_CDP_TARGET=amazon.com and avoid parallel Amazon commands against the same browser target.',
    ].join(' ');
}
