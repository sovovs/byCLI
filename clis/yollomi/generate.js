...
cli({
    ...
    args: [
        ...
        { name: 'image', help: 'Input image URL for image-to-image (upload via "bycli yollomi upload" first)' },
    ...
    func: async (page, kwargs) => {
        ...
        if (!apiPath)
            throw new CliError('INVALID_MODEL', `Unknown model: ${modelId}`, 'Run "bycli yollomi models --type image" to see available models');
        let body;
