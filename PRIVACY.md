# Privacy Policy — byCLI Browser Extension

**Last updated**: 2026-03-25

## What the extension does

The byCLI Browser Extension is a bridge between the [byCLI](https://github.com/sovovs/byCLI) command-line tool and your Chrome browser. It receives commands from a **locally running daemon** process via WebSocket (`localhost` only) and executes them in **isolated Chrome windows** that are separate from your normal browsing session.
...
https://github.com/sovovs/byCLI/tree/main/extension

## Contact

For privacy questions or concerns, please open an issue at:
https://github.com/sovovs/byCLI/issues
