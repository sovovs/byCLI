 ...
 * Runs the built bycli binary as a subprocess.
 */
...
/**
 * Run `bycli` as a child process with the given arguments.
 * Without PLAYWRIGHT_MCP_EXTENSION_TOKEN, bycli auto-launches its own browser.
 */
export async function runCli(
  ...
  try {
    const runtime = process.env.BYCLI_TEST_RUNTIME || 'node';
