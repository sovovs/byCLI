...
| Command | Description |
|---------|-------------|
| `bycli weread-official search <keyword>` | Search the WeRead store via `/store/search` (9 scope codes) |
| `bycli weread-official shelf` | Sync your shelf — books, albums, and the `文章收藏` (article) entry |
| `bycli weread-official book <bookId>` | Book metadata + chapter list + reading progress (3-in-1) |
| `bycli weread-official notes [bookId]` | Notebook overview, or merged highlights + thoughts for a specific book |
| `bycli weread-official review <bookId>` | Browse public reviews of a book |
| `bycli weread-official readdata` | Reading statistics: time, streak, preferences, top books |
| `bycli weread-official discover [bookId]` | Personalized recommendations (no bookId) or similar books (with bookId) |
| `bycli weread-official list-apis` | List every `api_name` supported by the gateway (meta endpoint) |

## Usage Examples

```bash
# Search
bycli weread-official search "三体"
bycli weread-official search "刘慈欣" --scope author --count 20
bycli weread-official search "AI" --scope ebook --max-idx 20   # next page

# Shelf — books + albums + article-bookmark entry
bycli weread-official shelf

# Book detail (info + chapters + progress)
bycli weread-official book 3300045871
bycli weread-official book 3300045871 --no-chapters   # skip chapter list
bycli weread-official book 3300045871 --no-progress   # skip reading progress

# Notebook overview (all books you've annotated)
bycli weread-official notes
bycli weread-official notes --last-sort 1748563200    # next page cursor

# Merged highlights + thoughts for a specific book
bycli weread-official notes 3300045871

# Public reviews of a book
bycli weread-official review 3300045871
bycli weread-official review 3300045871 --type recommend --count 20
bycli weread-official review 3300045871 --type newest

# Reading statistics
bycli weread-official readdata --mode weekly
bycli weread-official readdata --mode monthly
bycli weread-official readdata --mode annually
bycli weread-official readdata --mode overall
bycli weread-official readdata --mode weekly --base-time 1748563200

# Discover — personalized recommendations
bycli weread-official discover --count 20

# Discover — books similar to a given one
bycli weread-official discover 3300045871 --count 20

# Meta — list every gateway endpoint
bycli weread-official list-apis

# JSON output (useful for piping into other tools)
bycli weread-official book 3300045871 -f json
```
