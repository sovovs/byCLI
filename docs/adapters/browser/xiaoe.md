...
| Command | Description |
|---------|-------------|
| `bycli xiaoe courses` | List purchased courses with course URLs and shop names |
| `bycli xiaoe detail <url>` | Read course metadata such as title, price, student count, and shop |
| `bycli xiaoe catalog <url>` | Read the full course outline for normal courses, columns, and big columns |
| `bycli xiaoe play-url <url>` | Resolve the M3U8 playback URL for video lessons or live replays |
| `bycli xiaoe content <url>` | Extract rich-text lesson or page content as plain text |
...
bycli xiaoe detail "https://appxxxx.h5.xet.citv.cn/p/course/ecourse/v_xxxxx"

# Read the course outline
bycli xiaoe catalog "https://appxxxx.h5.xet.citv.cn/p/course/ecourse/v_xxxxx"

# Resolve a lesson M3U8 URL
bycli xiaoe play-url "https://appxxxx.h5.xet.citv.cn/v1/course/video/v_xxxxx?product_id=p_xxxxx" -f json

# Extract page content
bycli xiaoe content "https://appxxxx.h5.xet.citv.cn/v1/course/text/t_xxxxx"
```
