...
| Command | Description |
|---------|-------------|
| `bycli maimai search-talents` | Search Maimai talent profiles with keyword and structured filters |

## Usage Examples

```bash
# Search by keyword
bycli maimai search-talents Java

# Narrow by company and city
bycli maimai search-talents 产品经理 --companies "阿里巴巴,字节跳动" --cities 北京市

# Filter by school, degree, and work years
bycli maimai search-talents 算法 --schools "北京大学,清华大学" --degrees 3 --worktimes 3

# Prioritize recently active candidates
bycli maimai search-talents 运营 --sortby 1 --is_direct_chat 1

# JSON output for downstream processing
bycli maimai search-talents Java --size 10 -f json
```
