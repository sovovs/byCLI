...
| Command | Description |
|---------|-------------|
| `bycli endoflife product <name>` | Release cycles + EOL / LTS / support dates for one product |

## Usage Examples

```bash
# Node.js cycles (newest first)
bycli endoflife product nodejs

# Python, JSON output for scripts
bycli endoflife product python -f json

# Ubuntu LTS schedule
bycli endoflife product ubuntu
```
