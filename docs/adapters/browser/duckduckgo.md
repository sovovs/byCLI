...
| Command | Description |
|---------|-------------|
| `bycli duckduckgo search <keyword>` | Search DuckDuckGo and extract results from the page |
| `bycli duckduckgo suggest <keyword>` | Get DuckDuckGo search suggestions |
...
```bash
# Basic search
bycli duckduckgo search "machine learning"

# Limit results
bycli duckduckgo search "machine learning" --limit 5

# Region-specific search
bycli duckduckgo search "machine learning" --region jp-jp

# Time filter (past week)
bycli duckduckgo search "machine learning" --time w

# Pagination (second page)
bycli duckduckgo search "machine learning" --offset 10

# JSON output
bycli duckduckgo search "machine learning" -f json

# Search suggestions
bycli duckduckgo suggest "machine" --limit 5
```
