...
| Command | Description |
|---------|-------------|
| `bycli wttr current <location>` | Current weather conditions (single row) |
| `bycli wttr forecast <location>` | Multi-day forecast (1–3 days, free-tier max) |

## Usage Examples

```bash
# Current conditions by city name
bycli wttr current Tokyo
bycli wttr current "New York"

# By lat,lon
bycli wttr current "37.7749,-122.4194"

# By airport ICAO
bycli wttr current KSFO

# 3-day forecast
bycli wttr forecast Paris
bycli wttr forecast Paris --days 2
```
