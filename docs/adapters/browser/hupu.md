...
| Command | Description |
|---------|-------------|
| `bycli hupu hot` | Read Hupu hot threads |
| `bycli hupu search <keyword>` | Search Hupu threads by keyword |
| `bycli hupu detail <tid>` | Read one thread and optional hot replies |
| `bycli hupu mentions` | Read replies that mentioned you |
| `bycli hupu reply <tid> <text>` | Reply to a thread or quote one reply |
| `bycli hupu like <tid> <pid>` | Like one reply |
| `bycli hupu unlike <tid> <pid>` | Cancel like on one reply |

## Usage Examples

```bash
# Hot threads
bycli hupu hot --limit 5

# Search threads
bycli hupu search 湖人 --limit 10

# Read one thread and include hot replies
bycli hupu detail 638234927 --replies true

# Read mentions that replied to you
bycli hupu mentions --limit 20

# Reply to the thread
bycli hupu reply 638234927 "hello from bycli" --topic_id 502

# Quote one hot reply by pid
bycli hupu reply 638234927 "replying to this comment" --topic_id 502 --quote_id 174908

# Like / unlike one reply
bycli hupu like 638234927 174908 --fid 4860
bycli hupu unlike 638234927 174908 --fid 4860

# JSON output
bycli hupu detail 638234927 -f json
```
