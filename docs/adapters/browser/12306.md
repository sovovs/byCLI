...
|---------|------|-------------|
| `bycli 12306 stations` | Public | Search the station bundle by Chinese name, telecode, full pinyin, or short alias |
| `bycli 12306 trains` | Public | Trains between two stations on a given date with per-seat-class availability |
| `bycli 12306 train` | Public | Stop list (arrive / depart / stopover time) for one train segment |
| `bycli 12306 price` | Public | Ticket prices by seat class for one train segment + date |
| `bycli 12306 me` | Browser (cookie) | Logged-in account summary (sensitive fields masked by default) |
| `bycli 12306 passengers` | Browser (cookie) | Saved passenger list (sensitive fields masked by default) |
| `bycli 12306 orders` | Browser (cookie) | In-progress orders (not yet ridden / refunded / completed) |

## Usage Examples

```bash
# Search stations
bycli 12306 stations 上海 --limit 5
bycli 12306 stations beijing
bycli 12306 stations AOH        # by telecode

# List trains between two stations
bycli 12306 trains 北京 上海 --date 2026-05-22 --limit 20
bycli 12306 trains BJP AOH --date 2026-05-22

# Show stops for one train
bycli 12306 train 24000000G10L --from 北京南 --to 上海虹桥 --date 2026-05-22

# Ticket prices by seat class
bycli 12306 price 24000000G10L --from 北京南 --to 上海虹桥 --date 2026-05-22

# Authenticated commands (require login on kyfw.12306.cn first)
bycli 12306 me
bycli 12306 me --include-sensitive
bycli 12306 passengers --limit 10
bycli 12306 orders
bycli 12306 orders --include-sensitive

# JSON output
bycli 12306 trains 北京 上海 --date 2026-05-22 -f json
```
...
logged-in 12306 session in the same Chrome instance that byCLI's bridge
