...
| Command | Description |
|---------|-------------|
| `bycli tiktok profile` | Get user profile info |
| `bycli tiktok search` | Search videos |
| `bycli tiktok explore` | Trending videos from explore page |
| `bycli tiktok user` | Get recent videos from a user via page-context APIs |
| `bycli tiktok following` | List accounts you follow |
| `bycli tiktok friends` | Friend suggestions |
| `bycli tiktok live` | Browse live streams |
| `bycli tiktok notifications` | Get notifications |
| `bycli tiktok creator-videos` | List TikTok Studio creator videos and metrics |
| `bycli tiktok like` | Like a video |
| `bycli tiktok unlike` | Unlike a video |
| `bycli tiktok save` | Add to Favorites |
| `bycli tiktok unsave` | Remove from Favorites |
| `bycli tiktok follow` | Follow a user |
| `bycli tiktok unfollow` | Unfollow a user |
| `bycli tiktok comment` | Comment on a video |

## Usage Examples

```bash
# View a user's profile
bycli tiktok profile --username tiktok

# Search videos
bycli tiktok search "cooking" --limit 10

# Trending explore videos
bycli tiktok explore --limit 20

# Recent videos from a user
bycli tiktok user dictogo --limit 20

# Browse live streams
bycli tiktok live --limit 10

# List who you follow
bycli tiktok following

# List your TikTok Studio creator videos
bycli tiktok creator-videos --limit 20

# Friend suggestions
bycli tiktok friends --limit 10

# Like/unlike a video
bycli tiktok like "https://www.tiktok.com/@user/video/123"
bycli tiktok unlike "https://www.tiktok.com/@user/video/123"

# Save/unsave (Favorites)
bycli tiktok save "https://www.tiktok.com/@user/video/123"
bycli tiktok unsave "https://www.tiktok.com/@user/video/123"

# Follow/unfollow
bycli tiktok follow nasa
bycli tiktok unfollow nasa

# Comment on a video
bycli tiktok comment "https://www.tiktok.com/@user/video/123" "Great!"

# JSON output
bycli tiktok profile --username tiktok -f json
```
...
> Importing `retryable` as a first-class metadata layer in byCLI core is a
