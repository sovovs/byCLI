...
| Command | Description |
|---------|-------------|
| `bycli linkedin-learning search` | Search courses, videos, and paths by keyword via `learning-api/searchV2` |
| `bycli linkedin-learning trending` | Browse personalized recommendation carousels via `learning-api/feedRecommendationGroups` |
| `bycli linkedin-learning course` | Course detail by slug or full `/learning/<slug>` URL via `learning-api/courses?q=slug` |

## Usage Examples

```bash
# Search
bycli linkedin-learning search "AI agent"
bycli linkedin-learning search "rust programming" --limit 20

# Personalized recommendations
bycli linkedin-learning trending --limit 10

# Course detail (slug or full URL)
bycli linkedin-learning course agentic-ai-build-your-first-agentic-ai-system
bycli linkedin-learning course https://www.linkedin.com/learning/agentic-ai-build-your-first-agentic-ai-system

# JSON output
bycli linkedin-learning search "data science" -f json
```
