...
| Command | Description |
|---------|-------------|
| `bycli booking search` | Search hotels by destination + check-in/check-out dates |

## Usage Examples

```bash
# Basic — 2 adults, 1 room, default Booking page size (25 results)
bycli booking search Tokyo --checkin 2026-06-15 --checkout 2026-06-17

# Force result locale and currency
bycli booking search Paris --checkin 2026-07-01 --checkout 2026-07-03 \
  --lang en-us --currency USD

# Family stay — 2 adults + 2 children, 1 room
bycli booking search Singapore --checkin 2026-06-15 --checkout 2026-06-20 \
  --adults 2 --children 2

# Paginate (Booking pages 25 per request)
bycli booking search Tokyo --checkin 2026-06-15 --checkout 2026-06-17 --offset 25

# JSON output for downstream tooling
bycli booking search Tokyo --checkin 2026-06-15 --checkout 2026-06-17 -f json
```
