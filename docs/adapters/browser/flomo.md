...
| Command | Description |
|---------|-------------|
| `bycli flomo memos` | List your Flomo memos |
...
# Fetch all memos
bycli flomo memos --limit 200

# Filter by time (Unix timestamp)
bycli flomo memos --since 1735689600

# Continue from a memo cursor
bycli flomo memos --slug memo_abc123 --limit 50

# JSON output
bycli flomo memos --limit 200 -f json
```
