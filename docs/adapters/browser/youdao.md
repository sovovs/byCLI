...
| Command | Description |
|---------|-------------|
| `bycli youdao note <url>` | Read a public shared Youdao Note |
...
```bash
# Read a shared note
bycli youdao note "https://share.note.youdao.com/ynoteshare/index.html?id=YOUR_NOTE_ID&type=note"

# JSON output
bycli youdao note "https://share.note.youdao.com/ynoteshare/index.html?id=YOUR_NOTE_ID&type=note" -f json
```
