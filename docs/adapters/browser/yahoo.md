...
| Command | Description |
|---------|-------------|
| `bycli yahoo search <keyword>` | Search Yahoo (powered by Bing) and extract results from the page |
...
```bash
# Basic search
bycli yahoo search "machine learning"

# Limit results
bycli yahoo search "machine learning" --limit 5

# Pagination (second page)
bycli yahoo search "machine learning" --page 2

# JSON output
bycli yahoo search "machine learning" -f json
```
