...
|---------|-------------|------|
| `bycli sinafinance news` | 新浪财经 7×24 小时实时快讯 | 🌐 Public |
| `bycli sinafinance rolling-news` | 新浪财经滚动新闻 | 🔐 Browser |
| `bycli sinafinance stock` | 新浪财经行情（A股/港股/美股） | 🌐 Public |
| `bycli sinafinance stock-rank` | 新浪财经热搜榜 | 🔐 Browser |
...
bycli sinafinance news --limit 20

# Filter by type
bycli sinafinance news --type 1   # A股
bycli sinafinance news --type 2   # 宏观
bycli sinafinance news --type 6   # 国际

# JSON output
bycli sinafinance news -f json
```
...
```bash
# Rolling news feed
bycli sinafinance rolling-news

# JSON output
bycli sinafinance rolling-news -f json
```
...
bycli sinafinance stock 贵州茅台 --market cn

# Search and view HK stock
bycli sinafinance stock 腾讯控股 --market hk

# Search and view US stock
bycli sinafinance stock aapl --market us

# Auto-detect market (searches cn, hk, us in order)
bycli sinafinance stock 招商证券

# JSON output
bycli sinafinance stock 贵州茅台 -f json
```
...
```bash
# Default A股热搜榜
bycli sinafinance stock-rank

# 港股热搜榜
bycli sinafinance stock-rank --market hk

# 美股热搜榜
bycli sinafinance stock-rank --market us

# 外汇热搜榜
bycli sinafinance stock-rank --market ft

# 期货热搜榜
bycli sinafinance stock-rank --market wh

# JSON output
bycli sinafinance stock-rank -f json
```
