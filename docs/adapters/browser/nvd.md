...
| Command | Description |
|---------|-------------|
| `bycli nvd cve <id>` | Fetch a CVE detail (description, CVSS, CWE, KEV flag) |

## Usage Examples

```bash
# Log4Shell
bycli nvd cve CVE-2021-44228

# Heartbleed
bycli nvd cve CVE-2014-0160

# JSON output for downstream tooling
bycli nvd cve CVE-2021-44228 -f json
```
