...
| Command | Description |
|---------|-------------|
| `bycli brave search <keyword>` | Search Brave Search and extract results from the page |
...
```bash
# Basic search
bycli brave search "machine learning"

# Limit results
bycli brave search "machine learning" --limit 5

# Pagination (second page)
bycli brave search "machine learning" --offset 1

# JSON output
bycli brave search "machine learning" -f json
```
