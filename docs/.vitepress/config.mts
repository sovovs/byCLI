...
export default defineConfig({
  ...
  head: [
    ['meta', { property: 'og:title', content: 'byCLI Documentation' }],
          ...
          '/guide/': [
            {
              ...
              items: [
                ...
                { text: 'Extending byCLI', link: '/guide/extending-bycli' },
          ...
          '/zh/guide/': [
            {
              ...
              items: [
                ...
                { text: '扩展 byCLI', link: '/zh/guide/extending-bycli' },
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/sovovs/byCLI' },
      { icon: 'npm', link: 'https://www.npmjs.com/package/@sovovs/bycli' },
    ],

    editLink: {
      pattern: 'https://github.com/sovovs/byCLI/edit/main/docs/:path',
