...
`bycli convention-audit` scans adapter metadata plus source files for common
...
```bash
bycli convention-audit
bycli convention-audit --site twitter
bycli convention-audit twitter/search
bycli convention-audit --site pixiv -f yaml
bycli convention-audit --strict
```
