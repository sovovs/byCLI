...
This document reviews the current long-form docs, README surfaces, and developer guides in `bycli`. It focuses on stale facts, internal contradictions, and documentation structure that now causes drift.
...
- Reframe the section as:
  ...
  - “Sample sites”
- Keep `bycli list` and `docs/adapters/index.md` as the full registry surface.
