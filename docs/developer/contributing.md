...
Thanks for your interest in contributing to byCLI.

## Quick Start

```bash
# 1. Fork & clone
git clone git@github.com:<your-username>/bycli.git
cd bycli
...
# 5. Link globally (optional, for testing `bycli` command)
npm link
```
...
```bash
bycli <site> <command> --limit 3 -f json   # Test your command
bycli <site> <command> -v    # Verbose mode for debugging
```
