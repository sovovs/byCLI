---
description: How to turn a new Electron desktop app into an byCLI adapter
---

# Add a New Electron App CLI

This guide is the **fast entry point** for turning a new Electron desktop application into an byCLI adapter.
...
Then point byCLI at that CDP endpoint:
