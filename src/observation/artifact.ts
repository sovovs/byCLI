...
export function getTraceDirectory(contextId: string | undefined, traceId: string, baseDir: string = basebyCliDir()): string {
...
function renderSummary(
  ...
  const lines = [
    '---',
    'schemaVersion: 1',
    `bycliVersion: ${yamlScalar(PKG_VERSION)}`,
    ...
    '- For adapter repair policy and retry limits, use the `bycli-autofix` skill.',
