/**
 * Plugin lifecycle hooks: allows plugins to tap into bycli's execution lifecycle.
 *
...
declare global {
  ...
  var __bycli_hooks__: Map<HookName, HookFn[]> | undefined;
}
const _hooks: Map<HookName, HookFn[]> =
  globalThis.__bycli_hooks__ ??= new Map();
...
// ── Emit API (used internally by bycli core) ─────────────────────────────
