...
export const DEFAULT_BROWSER_CONNECT_TIMEOUT = parseEnvTimeout('BYCLI_BROWSER_CONNECT_TIMEOUT', 30);
export const DEFAULT_BROWSER_COMMAND_TIMEOUT = parseEnvTimeout('BYCLI_BROWSER_COMMAND_TIMEOUT', 60);
