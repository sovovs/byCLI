...
describe('extension release metadata', () => {
  it('ships CLI and extension 2.1.10 metadata consistently', () => {
    ...
    expect(cliPackage.version).toBe('2.1.10');
    expect(cliLock.version).toBe('2.1.10');
    expect(cliLock.packages[''].version).toBe('2.1.10');
    expect(manifest.version).toBe('2.1.10');
    expect(packageJson.version).toBe('2.1.10');
    expect(lock.version).toBe('2.1.10');
    expect(lock.packages[''].version).toBe('2.1.10');
  });
});
