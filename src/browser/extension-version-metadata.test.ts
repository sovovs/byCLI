...
describe('extension release metadata', () => {
  it('ships CLI and extension 2.1.11 metadata consistently', () => {
    ...
    expect(cliPackage.version).toBe('2.1.11');
    expect(cliLock.version).toBe('2.1.11');
    expect(cliLock.packages[''].version).toBe('2.1.11');
    expect(manifest.version).toBe('2.1.11');
    expect(packageJson.version).toBe('2.1.11');
    expect(lock.version).toBe('2.1.11');
