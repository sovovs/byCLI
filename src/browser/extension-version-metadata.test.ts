...
describe('extension release metadata', () => {
  it('ships CLI and extension 2.1.16 metadata consistently', () => {
    ...
    expect(cliPackage.version).toBe('2.1.16');
    expect(cliLock.version).toBe('2.1.16');
    expect(cliLock.packages[''].version).toBe('2.1.16');
    expect(manifest.version).toBe('2.1.16');
    expect(packageJson.version).toBe('2.1.16');
