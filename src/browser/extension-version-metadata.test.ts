...
describe('extension release metadata', () => {
  it('ships CLI and extension 2.1.14 metadata consistently', () => {
    ...
    expect(cliPackage.version).toBe('2.1.14');
    expect(cliLock.version).toBe('2.1.14');
    expect(cliLock.packages[''].version).toBe('2.1.14');
    expect(manifest.version).toBe('2.1.14');
    expect(packageJson.version).toBe('2.1.14');
    expect(lock.version).toBe('2.1.14');
    expect(lock.packages[''].version).toBe('2.1.14');
  });
});
